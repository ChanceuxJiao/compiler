...
static const char *const yytname[] =
{
  ...
  "DIV", "LEFT_PAREN", "RIGHT_PAREN", "NUMBER", "UMINUS", "LEFTPAR",
  "RIGHTPAR", "';'", "$accept", "lines", "expr", YY_NULLPTR
};
...
static const yytype_int8 yytable[] =
{
       ...
       8,     9,     0,     6,     0,     0,     0,    16,    17,    18,
      19,    10,    11,    12,    13,    10,    11,    12,    13,     0,
      15,    14
};
...
{
       0,     5,     6,     4,     4,    -1,     7,     7,     9,     9,
       3,     4,    -1,    13,    -1,    -1,    -1,    10,    11,    12,
      13,     3,     4,     5,     6,     3,     4,     5,     6,    -1,
       8,    13
};
...
{
       0,    15,     0,     4,     7,     9,    13,    16,    16,    16,
       3,     4,     5,     6,    13,     8,    16,    16,    16,    16
};
...
#line 41 "fundament.y"
                               { printf("%f\n", yyvsp[-1]); }
#line 1156 "fundament.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 47 "fundament.y"
                                { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1162 "fundament.tab.c"
    break;

  case 6: /* expr: expr MINUS expr  */
#line 48 "fundament.y"
                                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1168 "fundament.tab.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 49 "fundament.y"
                                { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1174 "fundament.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 50 "fundament.y"
                                { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1180 "fundament.tab.c"
    break;

  case 9: /* expr: MINUS expr  */
#line 52 "fundament.y"
                                          {yyval = - yyvsp[0];}
#line 1186 "fundament.tab.c"
    break;

  case 10: /* expr: LEFT_PAREN expr RIGHT_PAREN  */
#line 53 "fundament.y"
                                            { yyval = yyvsp[-1]; }
#line 1192 "fundament.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 54 "fundament.y"
                        {yyval = yyvsp[0];}
#line 1198 "fundament.tab.c"
    break;


#line 1202 "fundament.tab.c"
