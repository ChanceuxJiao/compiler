...
{
  "\"end of file\"", "error", "\"invalid token\"", "ADD", "MUL", "DIV",
  "LEFTPAR", "RIGHTPAR", "NUMBER", "MINUS", "UMINUS", "equal", "ID", "';'",
...
{
      -8,     0,    -8,     9,    -8,     9,    -7,    -8,    -2,    24,
      -8,     9,     9,     9,     9,     9,    -8,    -8,    31,    15,
      -8,    -8,    15
};
...
{
       2,    12,    13,    14,    11,     0,     3,    15,     4,     5,
       0,    16,     6,     7,     9,     3,    10,     4,     5,    13,
      14,     6,    18,    19,    20,    21,    22,    12,    13,    14,
       0,    17,     0,    15,    12,    13,    14,     0,     0,     0,
      15
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     5,    11,    -1,     6,     9,     8,     9,
      -1,    13,    12,    13,     3,     6,     5,     8,     9,     4,
       5,    12,    11,    12,    13,    14,    15,     3,     4,     5,
      -1,     7,    -1,     9,     3,     4,     5,    -1,    -1,    -1,
       9
};
...
{
       0,    15,     0,     6,     8,     9,    12,    13,    16,    16,
      16,    11,     3,     4,     5,     9,    13,     7,    16,    16,
      16,    16,    16
};
